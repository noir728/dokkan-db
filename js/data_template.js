const CHARACTER_DATA = [
    {
        ...
        forms: [
            // --- 1. 変身前 (基本状態) ---
            {
                ...
                stats: {
                    // 100%解放 (虹)
                    rainbow: { hp: 22250, atk: 21800, def: 14719 },
                    // 55%解放 (潜在ルート解放なし)
                    fifty:   { hp: 19650, atk: 18800, def: 11319 }, 
                    // 0%解放 (LvMaxのみ)
                    base:    { hp: 17650, atk: 16800, def: 9319 }
                },
            ...
            // なければこのブロック({ ... })は削除してください
            {
                ...
                id: 1000030,
                name: "変身後のキャラ名",
                stats: { hp: 15000, atk: 15000, def: 10000 }, // ステータスが変わる場合は変更
        ...
        forms_eza: [
            {
                label: "変身前",
                name: "キャラクター名 (極限)",
                stats: { hp: 18000, atk: 18000, def: 13000 }, // ステータス上昇
            ...
            // 変身後も同様に記述...
            {
                label: "変身後",
                name: "変身後キャラ名 (極限)",
                stats: { hp: 18000, atk: 18000, def: 13000 },
                active: { name: "...", condition: "...", effect: "..." },
                superAttacks: [ /* ... */ ],
                passive: { /* ... */ },
                links: [ /* ... */ ]
            }
        ...
        forms_seza: [
            {
                label: "変身前",
                name: "キャラクター名 (超極限)",
                stats: { hp: 22000, atk: 22000, def: 16000 }, // さらに上昇
                superAttacks: [ /* ... */ ],
                passive: { /* ... */ },
                links: [ /* ... */ ]
            }
